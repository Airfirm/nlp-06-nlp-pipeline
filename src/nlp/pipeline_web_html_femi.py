"""
src/nlp/pipeline_web_html_femi.py - Module 6 Script
...
Run from root project folder with:
  ...
  uv run python -m nlp.pipeline_web_html_femi
"""
...
from nlp.stage04_analyze_femi import run_analyze
from nlp.stage05_load_femi import run_load
